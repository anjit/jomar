...
<div class="page-content">
		  ...
		  <div class="col-md-10">
  			...
  			<div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title">News Details</div>
					</div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-md-4">
            <blockquote>
                <p><h3><?php echo $nys['title'];?><h3></p> 
            <p><i class="glyphicon glyphicon-calendar"></i> <?php echo date('M-d-Y',strtotime($nys['date']));?>
             </p>
            </blockquote>
             
          <h3>Description</h3>
          <p><?php echo $nys['description'];?></p>
        </div>
        </div>
</div>
  		<?php }?>		
