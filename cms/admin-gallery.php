		  ...
		  <div class="col-md-10">
  			...
  			<div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title">All Gallery Items</div>
				 <a href="add-gallery.php"><button class="btn btn-success  glyphicon-plus">Add Item</button></a>
				</div>
  				<div class="panel-body">
  					...
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
						...
						<tbody>
						<?php $images=$zoom->select('posts','post_type=5','*');
						...
						?>
							...
							<tr class="gradeA">
								...
								<td width="50%"><img src="<?php echo $image['url'];?>"  width='25%'/></td>
								...
								<td class="center">
	<a class="btn btn-primary glyphicon glyphicon-pencil" href="edit-gallery.php?page=<?php echo $image['id'];?>">Edit</a>
