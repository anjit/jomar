    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
  			...
  			<div class="content-box-large">
				 ...
				 <a href="add-project.php"><button class="btn btn-success  glyphicon-plus">Add Project</button></a>
				</div>
                ...
                <th>Description</th>
						...
						<tbody>
						<?php $news=$zoom->all('projects','*');
						  foreach ($news as $nys) {
						?>

							<tr class="gradeA">
                <td>1</td>
								<td><?php echo $nys['project_id'];?></td>
                <td width="20%"><?php echo $nys['title'];?></td>
								<td width="20%"><?php echo $zoom->excerpt($nys['description'],'100');?></td>
								...
								<td class="center">
		<a class="btn btn-primary glyphicon glyphicon-pencil" href="edit-project.php?page=<?php echo $nys['id'];?>"> Edit</a>
<form method="POST" action="delete.php" accept-charset="UTF-8" style="display:inline">
    ...
    <input type='hidden' value='projects' name='table' /> 
  <a class="btn btn-success glyphicon glyphicon-eye-open" href="view-project.php?page=<?php echo $nys['id'];?>"> View</a>
